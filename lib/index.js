...
function getElementSite(ele) {
  ...
  var marginLeft = parseFloat(ele.style.marginLeft || 0);
  var marginTop = parseFloat(ele.style.marginTop || 0);
  var x = _oDivObj.x;
  var y = _oDivObj.y;
  var newObj = {
    width: _oDivObj.width,
    height: _oDivObj.width,
    x: x,
    y: y
  };
  return newObj;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 10;
            return observer.emit("dropstart", currentNode, source, e, sibling);
